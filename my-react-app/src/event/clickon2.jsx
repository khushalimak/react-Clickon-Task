const ClickOn3 = () => {
 ...
 return (
   <div>
     ...
     <button className="px-12 h-16 w-48 bg-purple-600 hover:text-white text-2xl m-10 hover:border-4 border-black" onClick={handleClick("decode youe skill")}>ClickMe</button>
